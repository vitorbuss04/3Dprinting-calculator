                  ...
                  <Card key={material.id} className="relative overflow-hidden hover:shadow-lg transition-shadow duration-300 flex flex-col">
                    <div className="flex-grow">
                      ...
                      <div className="grid grid-cols-2 gap-3 mb-3">
                        <div className="col-span-2"><Input label="Nome/Marca" value={material.name} onChange={(e) => handleAssetUpdate(material.id, 'material', 'name', e.target.value)} /></div>
                        <div className="col-span-1"><Select label="Tipo" value={material.type} onChange={(e) => handleAssetUpdate(material.id, 'material', 'type', e.target.value)} options={Object.values(MaterialType).map(t => ({ value: t, label: t }))} /></div>
                        <div className="col-span-1"><Input type="color" label="Cor" value={material.color || '#000000'} onChange={(e) => handleAssetUpdate(material.id, 'material', 'color', e.target.value)} className="h-[46px] p-1 cursor-pointer" /></div>
