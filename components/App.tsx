...
import { Toaster } from 'react-hot-toast'; // Step 1: Ensure it's imported
      ...
      <Toaster 
        ...
        toastOptions={{
          ...
          style: {
            ...
            background: '#333',
            color: '#fff',
            boxShadow: '0 10px 25px -5px rgba(0,0,0,0.2), 0 5px 10px -6px rgba(0,0,0,0.2)'
          },
          success: {
            // Override for success toasts
            style: {
