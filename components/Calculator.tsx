...
export const Calculator: React.FC = () => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch lg:h-[calc(100vh-128px)] lg:-mb-10 lg:overflow-hidden animate-in fade-in duration-300">
      ...
      <div className="lg:col-span-5 lg:h-full lg:overflow-hidden flex flex-col gap-4">
        <div className="bg-surface-card/65 backdrop-blur-lg border border-hairline/80 shadow-xl rounded-2xl p-5 relative overflow-hidden flex flex-col justify-between h-full gap-4 cockpit-card">
